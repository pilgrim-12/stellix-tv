  ...
  return (
    <div className="flex h-screen flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        {/* Main content - Grid on tablet landscape and md+, flex-col on mobile */}
        <div className="h-full flex flex-col tablet-landscape:grid tablet-landscape:grid-cols-[1fr_14rem] md:grid md:grid-cols-[1fr_16rem] lg:grid-cols-[1fr_18rem] xl:grid-cols-[1fr_20rem] overflow-hidden">
          {/* Player section */}
          <div className="shrink-0 tablet-landscape:min-h-0 md:min-h-0 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 tablet-landscape:flex-none md:flex-none border-t tablet-landscape:border-t-0 tablet-landscape:border-l md:border-t-0 md:border-l border-border/40 flex flex-col overflow-hidden mobile-landscape:hidden">
            {/* Language filter */}
            <LanguageFilter />
      ...
      <div className="hidden tablet-landscape:flex md:flex shrink-0 border-t border-border/40 bg-muted/30 px-3 py-1 items-center justify-between text-[10px] text-muted-foreground mobile-landscape:hidden">
